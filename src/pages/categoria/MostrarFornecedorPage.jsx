                ...
                <div>
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', flexWrap: 'wrap', }}>
                        ...
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={3}>
                                <FormControl variant="outlined" fullWidth required className={classes.input} name="tipoFornecedor">
                                    ...
                                    <Select label="Tipo de Fornecedor" name="tipoFornecedor" value={values.tipoFornecedor} disabled>
                        ...
                        <Grid container spacing={0}>
                            <Grid item>
                                <Button onClick={() => history.push("/fornecedores")} variant="outlined" startIcon={<PrintIcon />} className={classes.saveButton}>Imprimir</Button>
                            </Grid>
                            <Grid item>
